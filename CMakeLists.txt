...
add_library(FIO STATIC
	...
	${CMAKE_CURRENT_LIST_DIR}/FIO/ByteBuffer.cpp

	${CMAKE_CURRENT_LIST_DIR}/FIO/DNS.cpp
	${CMAKE_CURRENT_LIST_DIR}/FIO/Socket.cpp
	${CMAKE_CURRENT_LIST_DIR}/FIO/IPAddress.cpp
...
if(WIN32)
	...
	target_compile_definitions(FIO PUBLIC  -DFIO_WIN32=1)
	target_compile_definitions(FIO PRIVATE -DWIN32_LEAN_AND_MEAN=1)
elseif(LINUX)
